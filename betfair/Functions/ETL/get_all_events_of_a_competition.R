...
get_all_events_of_a_competition <- function(eventtypeid, competitionid, folder_name){
    ...
    for (i in 1:dim(all_events)[1]) {
        ...
        get_all_markets_of_an_event(eventtypeid, competitionid, all_events$event$id[i], folder_name)
    }
}
